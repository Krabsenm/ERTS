...
# IP: bd/system/ip/system_led_ip_0_1/system_led_ip_0_1.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_led_ip_0_1 || ORIG_REF_NAME==system_led_ip_0_1}]
...
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_axi_bram_ctrl_0_bram_1 || ORIG_REF_NAME==system_axi_bram_ctrl_0_bram_1}]
