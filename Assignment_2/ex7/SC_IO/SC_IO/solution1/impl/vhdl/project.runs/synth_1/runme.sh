...
HD_PWD='C:/Users/krabs/source/repos/ERTS/Assignment_2/ex7/SC_IO/SC_IO/solution1/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iosc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iosc.tcl
