...
HD_PWD='C:/Users/krabs/source/repos/ERTS/Assignment_2/ex7/SC_IO/SC_IO/solution1/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log iosc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source iosc.tcl -notrace
