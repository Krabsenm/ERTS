...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_inSwitch \
    op interface \
    ports { inSwitch { I 4 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_outLeds \
    op interface \
    ports { outLeds { O 4 vector } outLeds_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_iosc_switchs_V \
    op interface \
    ports { iosc_switchs_V { O 4 vector } iosc_switchs_V_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { iosc_secCounter_V { I 4 vector } } \
} "
}
