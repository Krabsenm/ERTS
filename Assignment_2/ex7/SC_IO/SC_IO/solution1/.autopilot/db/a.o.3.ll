; ModuleID = 'C:/Users/krabs/source/repos/ERTS/Assignment_2/ex7/SC_IO/SC_IO/solution1/.autopilot/db/a.o.3.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-f80:128:128-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S32"
target triple = "i686-pc-mingw32"

@ssdm_ins_iosc_0_0_sw = global i4 0               ; [#uses=0 type=i4*]
@ssdm_ins_iosc_0_0_se_1 = global i4 0             ; [#uses=0 type=i4*]
@ssdm_ins_iosc_0_0_se = global i1 false           ; [#uses=0 type=i1*]
@ssdm_ins_iosc_0_0_re = global i1 false           ; [#uses=0 type=i1*]
@ssdm_ins_iosc_0_0_ou = global i4 0               ; [#uses=0 type=i4*]
@ssdm_ins_iosc_0_0_in = global i4 0               ; [#uses=0 type=i4*]
@ssdm_ins_iosc_0_0_ct = global i4 0               ; [#uses=0 type=i4*]
@ssdm_ins_iosc_0_0_co = global i32 0              ; [#uses=0 type=i32*]
@ssdm_ins_iosc_0_0_cl = global i1 false           ; [#uses=0 type=i1*]
@llvm_global_ctors_1 = appending global [1 x void ()*] [void ()* @_GLOBAL__I_a] ; [#uses=0 type=[1 x void ()*]*]
@llvm_global_ctors_0 = appending global [1 x i32] [i32 65535] ; [#uses=0 type=[1 x i32]*]
@iosc_ssdm_thread_M_iosThread = external global i1 ; [#uses=1 type=i1*]
@iosc_ssdm_thread_M_iosPulseThread = external global i1 ; [#uses=1 type=i1*]
...
@p_str18 = private unnamed_addr constant [15 x i8] c"iosPulseThread\00", align 1 ; [#uses=4 type=[15 x i8]*]
@p_str17 = private unnamed_addr constant [17 x i8] c"-bus_bundle slv0\00", align 1 ; [#uses=3 type=[17 x i8]*]
@p_str16 = private unnamed_addr constant [10 x i8] c"AXI4LiteS\00", align 1 ; [#uses=3 type=[10 x i8]*]
...
@p_str = private unnamed_addr constant [5 x i8] c"iosc\00", align 1 ; [#uses=21 type=[5 x i8]*]

; [#uses=36]
declare void @llvm.dbg.value(metadata, i64, metadata) nounwind readnone

; [#uses=0]
define weak void @"iosc::iosc"(i1* %iosc_clk_m_if_Val, i1* %iosc_reset_m_if_Val, i4* %iosc_ctrl_m_if_Val_V, i4* %iosc_inSwitch_m_if_Val_V, i4* %iosc_outLeds_m_if_Val_V, i4* %iosc_switchs_V, i1* %iosc_secPulse_V, i4* %iosc_secCounter_V, i32* %iosc_counter_clk_V) {
  call void (...)* @_ssdm_op_SpecIFCore(i4* %iosc_ctrl_m_if_Val_V, [1 x i8]* @p_str10, [10 x i8]* @p_str16, [1 x i8]* @p_str10, i32 -1, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [17 x i8]* @p_str17)
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %iosc_clk_m_if_Val), !map !121
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %iosc_reset_m_if_Val), !map !125
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %iosc_ctrl_m_if_Val_V), !map !129
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %iosc_inSwitch_m_if_Val_V), !map !133
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %iosc_outLeds_m_if_Val_V), !map !137
  ...
  call void @llvm.dbg.value(metadata !{i1* %iosc_clk_m_if_Val}, i64 0, metadata !157), !dbg !2121 ; [debug line = 22:3] [debug variable = iosc.clk.m_if.Val]
  call void @llvm.dbg.value(metadata !{i1* %iosc_reset_m_if_Val}, i64 0, metadata !2122), !dbg !2121 ; [debug line = 22:3] [debug variable = iosc.reset.m_if.Val]
  call void @llvm.dbg.value(metadata !{i4* %iosc_ctrl_m_if_Val_V}, i64 0, metadata !2123), !dbg !2121 ; [debug line = 22:3] [debug variable = iosc.ctrl.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %iosc_inSwitch_m_if_Val_V}, i64 0, metadata !2139), !dbg !2121 ; [debug line = 22:3] [debug variable = iosc.inSwitch.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %iosc_outLeds_m_if_Val_V}, i64 0, metadata !2140), !dbg !2121 ; [debug line = 22:3] [debug variable = iosc.outLeds.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %iosc_switchs_V}, i64 0, metadata !2151), !dbg !2121 ; [debug line = 22:3] [debug variable = iosc.switchs.V]
  call void @llvm.dbg.value(metadata !{i1* %iosc_secPulse_V}, i64 0, metadata !2154), !dbg !2121 ; [debug line = 22:3] [debug variable = iosc.secPulse.V]
  call void @llvm.dbg.value(metadata !{i4* %iosc_secCounter_V}, i64 0, metadata !2164), !dbg !2121 ; [debug line = 22:3] [debug variable = iosc.secCounter.V]
  call void @llvm.dbg.value(metadata !{i32* %iosc_counter_clk_V}, i64 0, metadata !2165), !dbg !2121 ; [debug line = 22:3] [debug variable = iosc.counter_clk.V]
  call void (...)* @_ssdm_op_SpecTopModule([5 x i8]* @p_str, [5 x i8]* @p_str) nounwind, !dbg !2175 ; [debug line = 24:5]
  %iosc_ssdm_thread_s = load i1* @iosc_ssdm_thread_M_iosThread, align 1, !dbg !2177 ; [#uses=1 type=i1] [debug line = 25:5]
  br i1 %iosc_ssdm_thread_s, label %1, label %2, !dbg !2177 ; [debug line = 25:5]

; <label>:1                                       ; preds = %0
  call void @"iosc::iosThread"(i1* %iosc_clk_m_if_Val, i1* %iosc_reset_m_if_Val, i4* %iosc_ctrl_m_if_Val_V, i4* %iosc_inSwitch_m_if_Val_V, i4* %iosc_outLeds_m_if_Val_V, i4* %iosc_switchs_V, i1* %iosc_secPulse_V, i4* %iosc_secCounter_V, i32* %iosc_counter_clk_V), !dbg !2178 ; [debug line = 25:36]
  br label %UnifiedUnreachableBlock

; <label>:2                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecProcessDecl([5 x i8]* @p_str, i32 2, [10 x i8]* @p_str8) nounwind, !dbg !2179 ; [debug line = 25:49]
  call void (...)* @_ssdm_op_SpecSensitive([10 x i8]* @p_str8, [4 x i8]* @p_str2, i1* %iosc_clk_m_if_Val, i32 1) nounwind, !dbg !2180 ; [debug line = 26:5]
  call void (...)* @_ssdm_op_SpecSensitive([10 x i8]* @p_str8, [6 x i8]* @p_str3, i1* %iosc_reset_m_if_Val, i32 3) nounwind, !dbg !2181 ; [debug line = 27:5]
  %iosc_ssdm_thread_1 = load i1* @iosc_ssdm_thread_M_iosPulseThread, align 1, !dbg !2182 ; [#uses=1 type=i1] [debug line = 28:5]
  br i1 %iosc_ssdm_thread_1, label %3, label %4, !dbg !2182 ; [debug line = 28:5]

; <label>:3                                       ; preds = %2
  call void @"iosc::iosPulseThread"(i1* %iosc_clk_m_if_Val, i1* %iosc_reset_m_if_Val, i4* %iosc_ctrl_m_if_Val_V, i4* %iosc_inSwitch_m_if_Val_V, i4* %iosc_outLeds_m_if_Val_V, i4* %iosc_switchs_V, i1* %iosc_secPulse_V, i4* %iosc_secCounter_V, i32* %iosc_counter_clk_V), !dbg !2183 ; [debug line = 28:41]
  br label %UnifiedUnreachableBlock

; <label>:4                                       ; preds = %2
  call void (...)* @_ssdm_op_SpecProcessDecl([5 x i8]* @p_str, i32 2, [15 x i8]* @p_str18) nounwind, !dbg !2184 ; [debug line = 28:59]
  call void (...)* @_ssdm_op_SpecSensitive([15 x i8]* @p_str18, [4 x i8]* @p_str2, i1* %iosc_clk_m_if_Val, i32 1) nounwind, !dbg !2185 ; [debug line = 29:5]
  call void (...)* @_ssdm_op_SpecSensitive([15 x i8]* @p_str18, [6 x i8]* @p_str3, i1* %iosc_reset_m_if_Val, i32 3) nounwind, !dbg !2186 ; [debug line = 30:5]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %iosc_clk_m_if_Val) nounwind, !dbg !2187 ; [debug line = 31:5]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %iosc_reset_m_if_Val) nounwind, !dbg !2188 ; [debug line = 32:5]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [5 x i8]* @p_str5, i32 0, i32 0, i4* %iosc_ctrl_m_if_Val_V) nounwind, !dbg !2189 ; [debug line = 33:5]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [9 x i8]* @p_str6, i32 0, i32 0, i4* %iosc_inSwitch_m_if_Val_V) nounwind, !dbg !2190 ; [debug line = 34:5]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 1, [13 x i8]* @p_str4, [8 x i8]* @p_str7, i32 0, i32 0, i4* %iosc_outLeds_m_if_Val_V) nounwind, !dbg !2191 ; [debug line = 35:5]
  call void @_ssdm_op_Write.ap_auto.i1P(i1* %iosc_secPulse_V, i1 false), !dbg !2192 ; [debug line = 378:13@36:3]
  call void @_ssdm_op_Write.ap_auto.i4P(i4* %iosc_secCounter_V, i4 0), !dbg !2196 ; [debug line = 378:13@37:3]
  call void @_ssdm_op_Write.ap_auto.i32P(i32* %iosc_counter_clk_V, i32 0), !dbg !2200 ; [debug line = 378:13@38:3]
  ret void, !dbg !2204                            ; [debug line = 43:1]
...
; [#uses=1]
define void @"iosc::iosThread"(i1* %iosc_clk_m_if_Val, i1* %iosc_reset_m_if_Val, i4* %iosc_ctrl_m_if_Val_V, i4* %iosc_inSwitch_m_if_Val_V, i4* %iosc_outLeds_m_if_Val_V, i4* %iosc_switchs_V, i1* %iosc_secPulse_V, i4* %iosc_secCounter_V, i32* %iosc_counter_clk_V) {
_ZN7_ap_sc_7sc_core4waitEi.exit:
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %iosc_secCounter_V), !map !149
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %iosc_counter_clk_V), !map !153
  call void @llvm.dbg.value(metadata !{i1* %iosc_clk_m_if_Val}, i64 0, metadata !2205), !dbg !2209 ; [debug line = 3:12] [debug variable = iosc.clk.m_if.Val]
  call void @llvm.dbg.value(metadata !{i1* %iosc_reset_m_if_Val}, i64 0, metadata !2210), !dbg !2209 ; [debug line = 3:12] [debug variable = iosc.reset.m_if.Val]
  call void @llvm.dbg.value(metadata !{i4* %iosc_ctrl_m_if_Val_V}, i64 0, metadata !2211), !dbg !2209 ; [debug line = 3:12] [debug variable = iosc.ctrl.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %iosc_inSwitch_m_if_Val_V}, i64 0, metadata !2212), !dbg !2209 ; [debug line = 3:12] [debug variable = iosc.inSwitch.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %iosc_outLeds_m_if_Val_V}, i64 0, metadata !2213), !dbg !2209 ; [debug line = 3:12] [debug variable = iosc.outLeds.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %iosc_switchs_V}, i64 0, metadata !2214), !dbg !2209 ; [debug line = 3:12] [debug variable = iosc.switchs.V]
  call void @llvm.dbg.value(metadata !{i1* %iosc_secPulse_V}, i64 0, metadata !2215), !dbg !2209 ; [debug line = 3:12] [debug variable = iosc.secPulse.V]
  call void @llvm.dbg.value(metadata !{i4* %iosc_secCounter_V}, i64 0, metadata !2216), !dbg !2209 ; [debug line = 3:12] [debug variable = iosc.secCounter.V]
  call void @llvm.dbg.value(metadata !{i32* %iosc_counter_clk_V}, i64 0, metadata !2217), !dbg !2209 ; [debug line = 3:12] [debug variable = iosc.counter_clk.V]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %iosc_clk_m_if_Val) nounwind, !dbg !2218 ; [debug line = 4:4]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %iosc_reset_m_if_Val) nounwind, !dbg !2220 ; [debug line = 5:3]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [5 x i8]* @p_str5, i32 0, i32 0, i4* %iosc_ctrl_m_if_Val_V) nounwind, !dbg !2221 ; [debug line = 6:3]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [9 x i8]* @p_str6, i32 0, i32 0, i4* %iosc_inSwitch_m_if_Val_V) nounwind, !dbg !2222 ; [debug line = 7:3]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 1, [13 x i8]* @p_str4, [8 x i8]* @p_str7, i32 0, i32 0, i4* %iosc_outLeds_m_if_Val_V) nounwind, !dbg !2223 ; [debug line = 8:3]
  call void (...)* @_ssdm_op_SpecProcessDef([5 x i8]* @p_str, i32 2, [10 x i8]* @p_str8) nounwind, !dbg !2224 ; [debug line = 9:3]
  %tmp_1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str9), !dbg !2225 ; [#uses=1 type=i32] [debug line = 9:105]
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, [1 x i8]* @p_str10) nounwind, !dbg !2226 ; [debug line = 9:189]
  %p_ssdm_reset_v = call i32 (...)* @_ssdm_op_SpecStateBegin(i32 0, i32 0, i32 1) nounwind, !dbg !2227 ; [#uses=1 type=i32] [debug line = 9:239]
  call void @llvm.dbg.value(metadata !{i32 %p_ssdm_reset_v}, i64 0, metadata !2228), !dbg !2227 ; [debug line = 9:239] [debug variable = _ssdm_reset_v]
  call void (...)* @_ssdm_op_SpecIFCore(i4* %iosc_ctrl_m_if_Val_V, [1 x i8]* @p_str10, [10 x i8]* @p_str16, [1 x i8]* @p_str10, i32 -1, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [17 x i8]* @p_str17), !dbg !2229 ; [debug line = 5:1]
  %empty = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %p_ssdm_reset_v) nounwind, !dbg !2230 ; [#uses=0 type=i32] [debug line = 5:92]
  %empty_2 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str9, i32 %tmp_1), !dbg !2231 ; [#uses=0 type=i32] [debug line = 5:130]
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !2232 ; [debug line = 803:19@8:1]
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2, !dbg !2239 ; [debug line = 9:5]

_ZN7_ap_sc_7sc_core4waitEi.exit2:                 ; preds = %2, %_ZN7_ap_sc_7sc_core4waitEi.exit
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !2240 ; [debug line = 803:19@14:3]
  %val_V = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %iosc_ctrl_m_if_Val_V), !dbg !2243 ; [#uses=1 type=i4] [debug line = 374:13@60:21@180:66@351:73@16:8]
  call void @llvm.dbg.value(metadata !{i4 %val_V}, i64 0, metadata !2262), !dbg !2243 ; [debug line = 374:13@60:21@180:66@351:73@16:8] [debug variable = val.V]
  %tmp = icmp eq i4 %val_V, 0, !dbg !2264         ; [#uses=1 type=i1] [debug line = 1983:9@3573:144@16:8]
  br i1 %tmp, label %1, label %0, !dbg !2261      ; [debug line = 16:8]

; <label>:0                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit2
  %val_V_3 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %iosc_inSwitch_m_if_Val_V), !dbg !2525 ; [#uses=1 type=i4] [debug line = 374:13@60:21@180:66@351:73@18:21]
  call void @llvm.dbg.value(metadata !{i4 %val_V_3}, i64 0, metadata !2262), !dbg !2525 ; [debug line = 374:13@60:21@180:66@351:73@18:21] [debug variable = val.V]
  %val_V_4 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %iosc_ctrl_m_if_Val_V), !dbg !2531 ; [#uses=1 type=i4] [debug line = 374:13@60:21@180:66@351:73@18:39]
  call void @llvm.dbg.value(metadata !{i4 %val_V_4}, i64 0, metadata !2262), !dbg !2531 ; [debug line = 374:13@60:21@180:66@351:73@18:39] [debug variable = val.V]
  call void @llvm.dbg.value(metadata !{i4 %val_V_3}, i64 0, metadata !2536), !dbg !2545 ; [debug line = 3374:0@18:39] [debug variable = lhs.V]
  call void @llvm.dbg.value(metadata !{i4 %val_V_4}, i64 0, metadata !2546), !dbg !2545 ; [debug line = 3374:0@18:39] [debug variable = rhs.V]
  %r_V = and i4 %val_V_4, %val_V_3, !dbg !2545    ; [#uses=1 type=i4] [debug line = 3374:0@18:39]
  call void @llvm.dbg.value(metadata !{i4 %r_V}, i64 0, metadata !2548), !dbg !2545 ; [debug line = 3374:0@18:39] [debug variable = r.V]
  br label %2, !dbg !2551                         ; [debug line = 19:4]

; <label>:1                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit2
  %iosc_secCounter_V_re = call i4 @_ssdm_op_Read.ap_auto.i4P(i4* %iosc_secCounter_V), !dbg !2552 ; [#uses=1 type=i4] [debug line = 378:13@22:11]
  br label %2

; <label>:2                                       ; preds = %1, %0
  %v_V = phi i4 [ %r_V, %0 ], [ %iosc_secCounter_V_re, %1 ] ; [#uses=2 type=i4]
  call void @_ssdm_op_Write.ap_auto.i4P(i4* %iosc_switchs_V, i4 %v_V), !dbg !2552 ; [debug line = 378:13@22:11]
  call void @llvm.dbg.value(metadata !{i4 %v_V}, i64 0, metadata !2555), !dbg !2563 ; [debug line = 206:21@427:73@24:3] [debug variable = v.V]
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %iosc_outLeds_m_if_Val_V, i4 %v_V), !dbg !2568 ; [debug line = 365:13@56:100@207:13@427:73@24:3]
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2, !dbg !2579 ; [debug line = 25:2]
}

; [#uses=1]
define void @"iosc::iosPulseThread"(i1* %iosc_clk_m_if_Val, i1* %iosc_reset_m_if_Val, i4* %iosc_ctrl_m_if_Val_V, i4* %iosc_inSwitch_m_if_Val_V, i4* %iosc_outLeds_m_if_Val_V, i4* %iosc_switchs_V, i1* %iosc_secPulse_V, i4* %iosc_secCounter_V, i32* %iosc_counter_clk_V) {
  call void (...)* @_ssdm_op_SpecIFCore(i4* %iosc_ctrl_m_if_Val_V, [1 x i8]* @p_str10, [10 x i8]* @p_str16, [1 x i8]* @p_str10, i32 -1, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [17 x i8]* @p_str17)
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %iosc_clk_m_if_Val), !map !121
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %iosc_reset_m_if_Val), !map !125
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %iosc_ctrl_m_if_Val_V), !map !129
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %iosc_secCounter_V), !map !149
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %iosc_counter_clk_V), !map !153
  call void @llvm.dbg.value(metadata !{i1* %iosc_clk_m_if_Val}, i64 0, metadata !2580), !dbg !2583 ; [debug line = 29:12] [debug variable = iosc.clk.m_if.Val]
  call void @llvm.dbg.value(metadata !{i1* %iosc_reset_m_if_Val}, i64 0, metadata !2584), !dbg !2583 ; [debug line = 29:12] [debug variable = iosc.reset.m_if.Val]
  call void @llvm.dbg.value(metadata !{i4* %iosc_ctrl_m_if_Val_V}, i64 0, metadata !2585), !dbg !2583 ; [debug line = 29:12] [debug variable = iosc.ctrl.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %iosc_inSwitch_m_if_Val_V}, i64 0, metadata !2586), !dbg !2583 ; [debug line = 29:12] [debug variable = iosc.inSwitch.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %iosc_outLeds_m_if_Val_V}, i64 0, metadata !2587), !dbg !2583 ; [debug line = 29:12] [debug variable = iosc.outLeds.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %iosc_switchs_V}, i64 0, metadata !2588), !dbg !2583 ; [debug line = 29:12] [debug variable = iosc.switchs.V]
  call void @llvm.dbg.value(metadata !{i1* %iosc_secPulse_V}, i64 0, metadata !2589), !dbg !2583 ; [debug line = 29:12] [debug variable = iosc.secPulse.V]
  call void @llvm.dbg.value(metadata !{i4* %iosc_secCounter_V}, i64 0, metadata !2590), !dbg !2583 ; [debug line = 29:12] [debug variable = iosc.secCounter.V]
  call void @llvm.dbg.value(metadata !{i32* %iosc_counter_clk_V}, i64 0, metadata !2591), !dbg !2583 ; [debug line = 29:12] [debug variable = iosc.counter_clk.V]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %iosc_clk_m_if_Val) nounwind, !dbg !2592 ; [debug line = 30:4]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %iosc_reset_m_if_Val) nounwind, !dbg !2594 ; [debug line = 31:3]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [5 x i8]* @p_str5, i32 0, i32 0, i4* %iosc_ctrl_m_if_Val_V) nounwind, !dbg !2595 ; [debug line = 32:3]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [9 x i8]* @p_str6, i32 0, i32 0, i4* %iosc_inSwitch_m_if_Val_V) nounwind, !dbg !2596 ; [debug line = 33:3]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 1, [13 x i8]* @p_str4, [8 x i8]* @p_str7, i32 0, i32 0, i4* %iosc_outLeds_m_if_Val_V) nounwind, !dbg !2597 ; [debug line = 34:3]
  call void (...)* @_ssdm_op_SpecProcessDef([5 x i8]* @p_str, i32 2, [15 x i8]* @p_str18) nounwind, !dbg !2598 ; [debug line = 35:3]
  %tmp = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str9), !dbg !2599 ; [#uses=1 type=i32] [debug line = 35:110]
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, [1 x i8]* @p_str10) nounwind, !dbg !2600 ; [debug line = 35:194]
  %p_ssdm_reset_v = call i32 (...)* @_ssdm_op_SpecStateBegin(i32 0, i32 0, i32 1) nounwind, !dbg !2601 ; [#uses=1 type=i32] [debug line = 35:244]
  call void @llvm.dbg.value(metadata !{i32 %p_ssdm_reset_v}, i64 0, metadata !2602), !dbg !2601 ; [debug line = 35:244] [debug variable = _ssdm_reset_v]
  %empty = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %p_ssdm_reset_v) nounwind, !dbg !2603 ; [#uses=0 type=i32] [debug line = 45:45]
  %empty_3 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str9, i32 %tmp), !dbg !2604 ; [#uses=0 type=i32] [debug line = 45:83]
  br label %1, !dbg !2605                         ; [debug line = 45:118]

; <label>:1                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit, %0
  %iosc_counter_clk_V_r = call i32 @_ssdm_op_Read.ap_auto.i32P(i32* %iosc_counter_clk_V), !dbg !2606 ; [#uses=1 type=i32] [debug line = 1824:147@1841:9@34:7]
  %iosc_counter_clk_V_a = add i32 %iosc_counter_clk_V_r, 1, !dbg !2606 ; [#uses=2 type=i32] [debug line = 1824:147@1841:9@34:7]
  call void @_ssdm_op_Write.ap_auto.i32P(i32* %iosc_counter_clk_V, i32 %iosc_counter_clk_V_a), !dbg !2606 ; [debug line = 1824:147@1841:9@34:7]
  %tmp_2 = icmp ugt i32 %iosc_counter_clk_V_a, 49999999, !dbg !2616 ; [#uses=1 type=i1] [debug line = 1991:9@3577:144@34:7]
  br i1 %tmp_2, label %2, label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !2614 ; [debug line = 34:7]

; <label>:2                                       ; preds = %1
  %iosc_secCounter_V_re = call i4 @_ssdm_op_Read.ap_auto.i4P(i4* %iosc_secCounter_V), !dbg !2626 ; [#uses=1 type=i4] [debug line = 1853:30@36:4]
  %tmp_3 = add i4 %iosc_secCounter_V_re, 1, !dbg !2631 ; [#uses=1 type=i4] [debug line = 1824:147@1854:9@36:4]
  call void @_ssdm_op_Write.ap_auto.i4P(i4* %iosc_secCounter_V, i4 %tmp_3), !dbg !2631 ; [debug line = 1824:147@1854:9@36:4]
  call void @_ssdm_op_Write.ap_auto.i32P(i32* %iosc_counter_clk_V, i32 0), !dbg !2637 ; [debug line = 378:13@37:4]
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !2639 ; [debug line = 40:3]

_ZN7_ap_sc_7sc_core4waitEi.exit:                  ; preds = %2, %1
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !2640 ; [debug line = 803:19@41:3]
  br label %1, !dbg !2642                         ; [debug line = 42:2]
}
