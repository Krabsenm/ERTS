; ModuleID = 'C:/Users/jonas/source/repos/ERTS/Mini_Project/HLS/Differentiate/solution8/.autopilot/db/a.o.2.bc'
...
; <label>:9                                       ; preds = %7
  %empty_7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([7 x i8]* @p_str5, i32 %tmp_8)
  br label %5
...
; <label>:10                                      ; preds = %5
  ...
  %empty_8 = call i32 (...)* @_ssdm_op_SpecRegionEnd([7 x i8]* @p_str4, i32 %tmp_4)
  %j_1 = add i6 1, %j
  br label %3
...
entry:
  ...
  %empty_16 = zext i6 %1 to i12
  %empty_17 = shl i12 %empty, 6
  %empty_18 = or i12 %empty_17, %empty_16
  ret i12 %empty_18
}
...
entry:
  ...
  %empty_19 = zext i4 %1 to i10
  %empty_20 = shl i10 %empty, 4
