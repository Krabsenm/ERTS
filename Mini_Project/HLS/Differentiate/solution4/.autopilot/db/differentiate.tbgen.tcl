...
set C_modelArgList {
	{ img int 8 regular {array 3072 { 1 1 } 1 1 }  }
	{ window_V int 3 regular {array 9 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ img_address1 sc_out sc_lv 12 signal 0 } 
	...
	{ window_V_address1 sc_out sc_lv 4 signal 1 } 
	{ window_V_ce1 sc_out sc_logic 1 signal 1 } 
	{ window_V_q1 sc_in sc_lv 3 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "img_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "img", "role": "address1" }} , 
 	...
 	{ "name": "window_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "window_V", "role": "address1" }} , 
 	{ "name": "window_V_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "window_V", "role": "ce1" }} , 
 	{ "name": "window_V_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "window_V", "role": "q1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.differentiate_macbkb_U0", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.differentiate_maccud_U1", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.differentiate_macdEe_U2", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	differentiate {
		img {Type I LastRead 6 FirstWrite -1}
		window_V {Type I LastRead 5 FirstWrite -1}
		res_V {Type O LastRead -1 FirstWrite 10}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "42781", "Max" : "42781"}
	, {"Name" : "Interval", "Min" : "42782", "Max" : "42782"}
]}
...
set Spec2ImplPortList { 
	img { ap_memory {  { img_address0 mem_address 1 12 }  { img_ce0 mem_ce 1 1 }  { img_q0 mem_dout 0 8 }  { img_address1 mem_address 1 12 }  { img_ce1 mem_ce 1 1 }  { img_q1 mem_dout 0 8 } } }
	window_V { ap_memory {  { window_V_address0 mem_address 1 4 }  { window_V_ce0 mem_ce 1 1 }  { window_V_q0 mem_dout 0 3 }  { window_V_address1 mem_address 1 4 }  { window_V_ce1 mem_ce 1 1 }  { window_V_q1 mem_dout 0 3 } } }
