...
#ifndef __differentiate_macdEe__HH__
#define __differentiate_macdEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(differentiate_macdEe) {
    ...
    SC_CTOR(differentiate_macdEe):  simcore_mac_2_U ("simcore_mac_2_U") {
