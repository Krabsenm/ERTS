...
#ifndef __differentiate_mulbkb__HH__
#define __differentiate_mulbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(differentiate_mulbkb) {
    ...
    SC_CTOR(differentiate_mulbkb):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
