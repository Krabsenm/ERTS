; ModuleID = 'C:/Users/jonas/source/repos/ERTS/Mini_Project/HLS/Differentiate/solution9/.autopilot/db/a.o.2.bc'
...
@p_str5 = private unnamed_addr constant [7 x i8] c"WinRow\00", align 1
...
; <label>:7                                       ; preds = %5
  ...
  %empty_6 = call i32 (...)* @_ssdm_op_SpecRegionEnd([7 x i8]* @p_str4, i32 %tmp_4)
  br label %3

; <label>:8                                       ; preds = %3
  %empty_7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([7 x i8]* @p_str3, i32 %tmp_1)
  %i_1 = add i6 %i, 1
  br label %1
...
entry:
  ...
  %empty_8 = shl i15 1, %empty
  %empty_9 = and i15 %0, %empty_8
  %empty_10 = icmp ne i15 %empty_9, 0
  ret i1 %empty_10
}
