; ModuleID = 'C:/Users/jonas/source/repos/ERTS/Mini_Project/HLS/Differentiate/solution7/.autopilot/db/a.o.2.bc'
...
; <label>:4                                       ; preds = %3
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 10, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind
  %tmp_2 = add i6 %j, -1
...
; <label>:5                                       ; preds = %3
  %empty_4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([7 x i8]* @p_str, i32 %tmp_1)
  br label %1
...
entry:
  ...
  %empty_8 = zext i6 %1 to i12
  %empty_9 = shl i12 %empty, 6
  %empty_10 = or i12 %empty_9, %empty_8
  ret i12 %empty_10
}
...
entry:
  ...
  %empty_11 = zext i4 %1 to i10
  %empty_12 = shl i10 %empty, 4
  %empty_13 = or i10 %empty_12, %empty_11
  ret i10 %empty_13
}
