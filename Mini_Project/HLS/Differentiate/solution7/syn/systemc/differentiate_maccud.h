...
#ifndef __differentiate_maccud__HH__
#define __differentiate_maccud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(differentiate_maccud) {
    ...
    SC_CTOR(differentiate_maccud):  simcore_mac_0_U ("simcore_mac_0_U") {
