; ModuleID = 'C:/Users/jonas/source/repos/ERTS/Mini_Project/HLS/Differentiate/solution10/.autopilot/db/a.o.2.bc'
...
@p_str6 = private unnamed_addr constant [7 x i8] c"WinCol\00", align 1
...
; <label>:6                                       ; preds = %5
  ...
  %tmp_8 = call i32 (...)* @_ssdm_op_SpecRegionBegin([7 x i8]* @p_str5)
...
; <label>:7                                       ; preds = %8, %6
  ...
  %empty_6 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 1, i64 1, i64 1)
...
; <label>:8                                       ; preds = %7
  ...
  %tmp_1_7 = sext i11 %r_V_1 to i16
  %temp_result_V_1_1 = add i16 %tmp_1_7, %temp_result_V_1
  %jj_1_1 = xor i2 %jj, -2
  br label %7

; <label>:9                                       ; preds = %7
  %empty_8 = call i32 (...)* @_ssdm_op_SpecRegionEnd([7 x i8]* @p_str5, i32 %tmp_8)
  br label %5
...
; <label>:10                                      ; preds = %5
  ...
  %empty_9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([7 x i8]* @p_str4, i32 %tmp_4)
  %j_1 = add i6 1, %j
  br label %3

; <label>:11                                      ; preds = %3
  %empty_10 = call i32 (...)* @_ssdm_op_SpecRegionEnd([7 x i8]* @p_str3, i32 %tmp_1)
  %i_1 = add i6 %i, 1
  br label %1
...
entry:
  ...
  %empty_17 = zext i6 %1 to i12
  %empty_18 = shl i12 %empty, 6
...
entry:
  ...
  %empty_20 = zext i4 %1 to i10
  %empty_21 = shl i10 %empty, 4
  %empty_22 = or i10 %empty_21, %empty_20
  ret i10 %empty_22
}
