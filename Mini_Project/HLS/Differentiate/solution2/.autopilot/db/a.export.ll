; ModuleID = 'C:/Users/jonas/source/repos/ERTS/Mini_Project/HLS/Differentiate/solution2/.autopilot/db/a.o.2.bc'
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_8 = mul i12 %tmp_cast_cast, 46
  br label %3

; <label>:3                                       ; preds = %7, %2
  %j = phi i6 [ 1, %2 ], [ %j_1, %7 ]
  %j_cast4_cast = zext i6 %j to i13
...
; <label>:4                                       ; preds = %3
  ...
  %tmp_2 = add i6 %j, -1
  %tmp_2_cast_cast3 = zext i6 %tmp_2 to i13
  %tmp_2_cast_cast = zext i6 %tmp_2 to i12
  %tmp_9 = add i12 %tmp_8, %tmp_2_cast_cast
...
; <label>:5                                       ; preds = %6, %4
  %p_s = phi i15 [ 0, %4 ], [ %temp_result_V_1_2, %6 ]
  %ii = phi i2 [ 0, %4 ], [ %ii_1, %6 ]
  ...
  %tmp_3 = sub i5 %p_shl_cast, %ii_cast2_cast
  ...
  %ii_1 = add i2 %ii, 1
  br i1 %exitcond3, label %7, label %6

; <label>:6                                       ; preds = %5
  call void (...)* @_ssdm_op_SpecLoopName([7 x i8]* @p_str2) nounwind
  %sum = add i6 %tmp, %ii_cast3
  %tmp_13 = call i12 @_ssdm_op_BitConcatenate.i12.i6.i6(i6 %sum, i6 0)
  %p_shl1_cast = zext i12 %tmp_13 to i13
  %tmp_14 = call i10 @_ssdm_op_BitConcatenate.i10.i6.i4(i6 %sum, i4 0)
  %p_shl2_cast = zext i10 %tmp_14 to i13
  %tmp_15 = sub i13 %p_shl1_cast, %p_shl2_cast
  %tmp_16 = add i13 %tmp_15, %tmp_2_cast_cast3
  %tmp_17_cast = sext i13 %tmp_16 to i32
  %img_addr = getelementptr [3072 x i8]* %img, i32 0, i32 %tmp_17_cast
  %tmp_17 = add i13 %tmp_15, %j_cast4_cast
  %tmp_18_cast = sext i13 %tmp_17 to i32
  %img_addr_1 = getelementptr [3072 x i8]* %img, i32 0, i32 %tmp_18_cast
  %tmp_18 = add i13 %tmp_15, %tmp_9_2_cast_cast
...
; <label>:7                                       ; preds = %5
  %tmp_12 = call i1 @_ssdm_op_BitSelect.i1.i15.i32(i15 %p_s, i32 14)
  %tmp_6 = sub i15 0, %p_s
  %tmp_7 = select i1 %tmp_12, i15 %tmp_6, i15 %p_s
  store i15 %tmp_7, i15* %res_V_addr, align 2
  %empty_4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([7 x i8]* @p_str1, i32 %tmp_4)
  br label %3

; <label>:8                                       ; preds = %3
  %empty_5 = call i32 (...)* @_ssdm_op_SpecRegionEnd([7 x i8]* @p_str, i32 %tmp_1)
  %i_1 = add i6 %i, 1
  br label %1
...
entry:
  ...
  %empty_9 = zext i2 %1 to i4
  %empty_10 = shl i4 %empty, 2
...
entry:
  ...
  %empty_12 = zext i6 %1 to i12
  %empty_13 = shl i12 %empty, 6
  %empty_14 = or i12 %empty_13, %empty_12
  ret i12 %empty_14
}
...
entry:
  ...
  %empty_15 = zext i4 %1 to i10
  %empty_16 = shl i10 %empty, 4
  %empty_17 = or i10 %empty_16, %empty_15
  ret i10 %empty_17
}
