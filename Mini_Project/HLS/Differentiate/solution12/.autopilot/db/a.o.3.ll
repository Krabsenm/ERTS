; ModuleID = 'C:/Users/jonas/source/repos/ERTS/Mini_Project/HLS/Differentiate/solution12/.autopilot/db/a.o.3.bc'
...
@p_str4 = private unnamed_addr constant [7 x i8] c"ImgCol\00", align 1 ; [#uses=1 type=[7 x i8]*]
...
define void @differentiate([3072 x i8]* %img, [9 x i3]* %window_V, [2852 x i15]* %res_V) {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [10 x i8]* @p_str2, i32 0, i32 0, [1 x i8]* @p_str, i32 0, i32 0, [8 x i8]* @p_str1, [1 x i8]* @p_str, [1 x i8]* @p_str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str) nounwind, !dbg !3084 ; [debug line = 7:1]
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_11 = mul i12 %tmp_cast_cast, 46, !dbg !3087 ; [#uses=1 type=i12] [debug line = 280:10@24:7]
...
; <label>:4                                       ; preds = %3
  ...
  %tmp_21 = add i12 %tmp_11, %tmp_2_cast_cast6, !dbg !3087 ; [#uses=1 type=i12] [debug line = 280:10@24:7]
  %tmp_22_cast = zext i12 %tmp_21 to i32, !dbg !3087 ; [#uses=1 type=i32] [debug line = 280:10@24:7]
  %res_V_addr = getelementptr [2852 x i15]* %res_V, i32 0, i32 %tmp_22_cast, !dbg !3087 ; [#uses=1 type=i15*] [debug line = 280:10@24:7]
  ...
  %tmp_25 = call i1 @_ssdm_op_BitSelect.i1.i15.i32(i15 %temp_result_V_1_2_2, i32 14), !dbg !3103 ; [#uses=1 type=i1] [debug line = 1987:9@3504:0@22:11]
  %tmp5 = add i12 %tmp_2_1_cast, %tmp_15_cast, !dbg !3369 ; [#uses=1 type=i12] [debug line = 121:90@121:106@23:23]
  ...
  %tmp13 = add i13 %tmp_8_cast, %tmp20_cast, !dbg !3369 ; [#uses=1 type=i13] [debug line = 121:90@121:106@23:23]
  ...
  %tmp_4 = sub i15 0, %tmp_s, !dbg !3368          ; [#uses=1 type=i15] [debug line = 22:11]
  %tmp_5 = select i1 %tmp_25, i15 %tmp_4, i15 %tmp_s, !dbg !3368 ; [#uses=1 type=i15] [debug line = 22:11]
  store i15 %tmp_5, i15* %res_V_addr, align 2, !dbg !3087 ; [debug line = 280:10@24:7]
  call void @llvm.dbg.value(metadata !{i6 %j_1}, i64 0, metadata !3375), !dbg !3376 ; [debug line = 10:39] [debug variable = j]
  br label %3, !dbg !3376                         ; [debug line = 10:39]

; <label>:5                                       ; preds = %3
  %empty_5 = call i32 (...)* @_ssdm_op_SpecRegionEnd([7 x i8]* @p_str3, i32 %tmp_1), !dbg !3377 ; [#uses=0 type=i32] [debug line = 26:3]
  call void @llvm.dbg.value(metadata !{i6 %i_1}, i64 0, metadata !3378), !dbg !3379 ; [debug line = 8:37] [debug variable = i]
  br label %1, !dbg !3379                         ; [debug line = 8:37]

; <label>:6                                       ; preds = %1
  ret void, !dbg !3380                            ; [debug line = 27:1]
}
...
entry:
  ...
  %empty_6 = shl i15 1, %empty                    ; [#uses=1 type=i15]
  %empty_7 = and i15 %0, %empty_6                 ; [#uses=1 type=i15]
  %empty_8 = icmp ne i15 %empty_7, 0              ; [#uses=1 type=i1]
  ret i1 %empty_8
}
...
entry:
  ...
  %empty_12 = zext i4 %1 to i10                   ; [#uses=1 type=i10]
  %empty_13 = shl i10 %empty, 4                   ; [#uses=1 type=i10]
...
!3375 = metadata !{i32 786688, metadata !1709, metadata !"j", metadata !1714, i32 10, metadata !87, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3376 = metadata !{i32 10, i32 39, metadata !1709, null}
!3377 = metadata !{i32 26, i32 3, metadata !1710, null}
!3378 = metadata !{i32 786688, metadata !1711, metadata !"i", metadata !1714, i32 8, metadata !87, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3379 = metadata !{i32 8, i32 37, metadata !1711, null}
!3380 = metadata !{i32 27, i32 1, metadata !1712, null}
