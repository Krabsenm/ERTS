; ModuleID = 'C:/Users/jonas/source/repos/ERTS/Mini_Project/HLS/Differentiate/solution5/.autopilot/db/a.o.2.bc'
...
; <label>:5                                       ; preds = %3
  %empty_3 = call i32 (...)* @_ssdm_op_SpecRegionEnd([7 x i8]* @p_str, i32 %tmp_1)
  br label %1
...
entry:
  ...
  %empty_4 = shl i15 1, %empty
  %empty_5 = and i15 %0, %empty_4
  %empty_6 = icmp ne i15 %empty_5, 0
  ret i1 %empty_6
}
...
entry:
  ...
  %empty_7 = zext i6 %1 to i12
  %empty_8 = shl i12 %empty, 6
...
entry:
  ...
  %empty_10 = zext i4 %1 to i10
  %empty_11 = shl i10 %empty, 4
  %empty_12 = or i10 %empty_11, %empty_10
  ret i10 %empty_12
}
