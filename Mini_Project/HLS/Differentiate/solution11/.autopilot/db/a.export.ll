; ModuleID = 'C:/Users/jonas/source/repos/ERTS/Mini_Project/HLS/Differentiate/solution11/.autopilot/db/a.o.2.bc'
...
ifBlock:                                          ; preds = %2
  ...
  %empty_4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([7 x i8]* @p_str5, i32 %tmp_8)
...
.reset:                                           ; preds = %1
  ...
  %empty_6 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 2852, i64 2852, i64 2852)
...
entry:
  ...
  %empty_10 = zext i2 %1 to i4
  %empty_11 = shl i4 %empty, 2
