...
#ifndef __differentiate_macbkb__HH__
#define __differentiate_macbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(differentiate_macbkb) {
    ...
    SC_CTOR(differentiate_macbkb):  simcore_mac_0_U ("simcore_mac_0_U") {
