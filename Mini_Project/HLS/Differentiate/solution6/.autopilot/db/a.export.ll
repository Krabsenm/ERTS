; ModuleID = 'C:/Users/jonas/source/repos/ERTS/Mini_Project/HLS/Differentiate/solution6/.autopilot/db/a.o.2.bc'
...
@p_str1 = private unnamed_addr constant [5 x i8] c"diff\00", align 1
...
define void @differentiate([3072 x i8]* %img, [9 x i3]* %window_V, [2852 x i15]* %res_V) {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [10 x i8]* @p_str2, i32 0, i32 0, [1 x i8]* @p_str, i32 0, i32 0, [5 x i8]* @p_str1, [1 x i8]* @p_str, [1 x i8]* @p_str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str) nounwind
...
; <label>:2                                       ; preds = %1
  %tmp_7 = call i12 @_ssdm_op_BitConcatenate.i12.i6.i6(i6 %i, i6 0)
  %p_shl4_cast = zext i12 %tmp_7 to i13
  %tmp_8 = call i10 @_ssdm_op_BitConcatenate.i10.i6.i4(i6 %i, i4 0)
  %p_shl5_cast = zext i10 %tmp_8 to i13
  %tmp_9 = sub i13 %p_shl4_cast, %p_shl5_cast
  ...
  %tmp_3 = call i12 @_ssdm_op_BitConcatenate.i12.i6.i6(i6 %tmp, i6 0)
  %p_shl2_cast = zext i12 %tmp_3 to i13
  %tmp_10 = call i10 @_ssdm_op_BitConcatenate.i10.i6.i4(i6 %tmp, i4 0)
  %p_shl3_cast = zext i10 %tmp_10 to i13
  %tmp_11 = sub i13 %p_shl2_cast, %p_shl3_cast
  %tmp_12 = mul i12 %tmp_cast_cast, 46
  %i_1 = add i6 %i, 1
  %tmp_13 = call i12 @_ssdm_op_BitConcatenate.i12.i6.i6(i6 %i_1, i6 0)
  %p_shl_cast = zext i12 %tmp_13 to i13
  %tmp_14 = call i10 @_ssdm_op_BitConcatenate.i10.i6.i4(i6 %i_1, i4 0)
  %p_shl1_cast = zext i10 %tmp_14 to i13
  %tmp_15 = sub i13 %p_shl_cast, %p_shl1_cast
  br label %3
...
; <label>:4                                       ; preds = %3
  ...
  %tmp_16 = add i13 %tmp_11, %j_cast_cast
  %tmp_17_cast = sext i13 %tmp_16 to i32
  %img_addr_1 = getelementptr [3072 x i8]* %img, i32 0, i32 %tmp_17_cast
  %tmp_17 = add i13 %tmp_9, %j_cast_cast
  %tmp_18_cast = sext i13 %tmp_17 to i32
  %img_addr_4 = getelementptr [3072 x i8]* %img, i32 0, i32 %tmp_18_cast
  %tmp_18 = add i13 %tmp_15, %j_cast_cast
  %tmp_19_cast = sext i13 %tmp_18 to i32
  %img_addr_7 = getelementptr [3072 x i8]* %img, i32 0, i32 %tmp_19_cast
  %empty_4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 46, i64 46, i64 46)
  call void (...)* @_ssdm_op_SpecLoopName([7 x i8]* @p_str4) nounwind
  %tmp_4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([7 x i8]* @p_str4)
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str) nounwind
  %tmp_2 = add i6 %j, -1
  %tmp_2_cast_cast6 = zext i6 %tmp_2 to i12
  %tmp_2_cast_cast = zext i6 %tmp_2 to i13
  %tmp_19 = add i13 %tmp_11, %tmp_2_cast_cast
  %tmp_20_cast = sext i13 %tmp_19 to i32
  %img_addr = getelementptr [3072 x i8]* %img, i32 0, i32 %tmp_20_cast
  %tmp_20 = add i13 %tmp_9, %tmp_2_cast_cast
  %tmp_21_cast = sext i13 %tmp_20 to i32
  %img_addr_3 = getelementptr [3072 x i8]* %img, i32 0, i32 %tmp_21_cast
  %tmp_21 = add i13 %tmp_15, %tmp_2_cast_cast
  %tmp_22_cast = sext i13 %tmp_21 to i32
  %img_addr_6 = getelementptr [3072 x i8]* %img, i32 0, i32 %tmp_22_cast
  %tmp_22 = add i12 %tmp_12, %tmp_2_cast_cast6
  %tmp_23_cast = zext i12 %tmp_22 to i32
  %res_V_addr = getelementptr [2852 x i15]* %res_V, i32 0, i32 %tmp_23_cast
  ...
  %tmp_23 = add i13 %tmp_11, %j_1_cast_cast
  %tmp_24_cast = sext i13 %tmp_23 to i32
  %img_addr_2 = getelementptr [3072 x i8]* %img, i32 0, i32 %tmp_24_cast
  %tmp_24 = add i13 %tmp_9, %j_1_cast_cast
  %tmp_25_cast = sext i13 %tmp_24 to i32
  %img_addr_5 = getelementptr [3072 x i8]* %img, i32 0, i32 %tmp_25_cast
  %tmp_25 = add i13 %tmp_15, %j_1_cast_cast
  %tmp_26_cast = sext i13 %tmp_25 to i32
  %img_addr_8 = getelementptr [3072 x i8]* %img, i32 0, i32 %tmp_26_cast
  ...
  %tmp_9_cast = sext i11 %r_V_1 to i13
  ...
  %tmp_16_cast = sext i11 %r_V_2 to i12
  ...
  %tmp_26 = call i1 @_ssdm_op_BitSelect.i1.i15.i32(i15 %temp_result_V_1_2_2, i32 14)
  %tmp5 = add i12 %tmp_2_1_cast, %tmp_16_cast
  ...
  %tmp13 = add i13 %tmp_9_cast, %tmp20_cast
  ...
  %tmp_5 = sub i15 0, %tmp_s
  %tmp_6 = select i1 %tmp_26, i15 %tmp_5, i15 %tmp_s
  store i15 %tmp_6, i15* %res_V_addr, align 2
  %empty_5 = call i32 (...)* @_ssdm_op_SpecRegionEnd([7 x i8]* @p_str4, i32 %tmp_4)
  br label %3

; <label>:5                                       ; preds = %3
  %empty_6 = call i32 (...)* @_ssdm_op_SpecRegionEnd([7 x i8]* @p_str3, i32 %tmp_1)
  br label %1
...
entry:
  ...
  %empty_7 = shl i15 1, %empty
  %empty_8 = and i15 %0, %empty_7
  %empty_9 = icmp ne i15 %empty_8, 0
  ret i1 %empty_9
}
...
entry:
  ...
  %empty_10 = zext i6 %1 to i12
  %empty_11 = shl i12 %empty, 6
  %empty_12 = or i12 %empty_11, %empty_10
  ret i12 %empty_12
}
