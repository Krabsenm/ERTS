...
parameter    C_S_AXI_DIFF_DATA_WIDTH = 32;
parameter    C_S_AXI_DIFF_ADDR_WIDTH = 14;
parameter    C_S_AXI_DATA_WIDTH = 32;

parameter C_S_AXI_DIFF_WSTRB_WIDTH = (32 / 8);
...
input   s_axi_diff_AWVALID;
output   s_axi_diff_AWREADY;
input  [C_S_AXI_DIFF_ADDR_WIDTH - 1:0] s_axi_diff_AWADDR;
input   s_axi_diff_WVALID;
output   s_axi_diff_WREADY;
input  [C_S_AXI_DIFF_DATA_WIDTH - 1:0] s_axi_diff_WDATA;
input  [C_S_AXI_DIFF_WSTRB_WIDTH - 1:0] s_axi_diff_WSTRB;
input   s_axi_diff_ARVALID;
output   s_axi_diff_ARREADY;
input  [C_S_AXI_DIFF_ADDR_WIDTH - 1:0] s_axi_diff_ARADDR;
output   s_axi_diff_RVALID;
input   s_axi_diff_RREADY;
output  [C_S_AXI_DIFF_DATA_WIDTH - 1:0] s_axi_diff_RDATA;
output  [1:0] s_axi_diff_RRESP;
output   s_axi_diff_BVALID;
input   s_axi_diff_BREADY;
output  [1:0] s_axi_diff_BRESP;
output   interrupt;
