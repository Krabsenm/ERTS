...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "differentiate.autotvin.dat"
	set constFileTvOut       "differentiate.autotvout.dat"
	set constFileHdlTvIn     "differentiate.autohdltvin.dat"
	set constFileHdlTvOut    "differentiate.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
