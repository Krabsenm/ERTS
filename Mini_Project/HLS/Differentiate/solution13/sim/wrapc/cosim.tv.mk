...
$(ObjDir)/differentiate_test.cpp_pre.cpp.tb.o : differentiate_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling differentiate_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/differentiate.cpp_pre.cpp.tb.o : differentiate.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling differentiate.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
