...
if {[file isfile differentiate.autotvin.dat]} {
	file delete -force differentiate.autotvin.dat
}

if {[file isfile differentiate.autotvout.dat]} {
	file delete -force differentiate.autotvout.dat
}
