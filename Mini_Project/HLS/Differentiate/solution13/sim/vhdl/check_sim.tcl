...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.differentiate.autotvin_img.dat"
         "c.differentiate.autotvin_window_V.dat"
         "c.differentiate.autotvin_res_V.dat"
         "c.differentiate.autotvout_res_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.differentiate.autotvout_res_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
