...
set Library     "hls"
set IPName      "differentiate"
set Version     "1.0"
set DisplayName "Differentiate"
set Revision    "1912271429"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "differentiate"
...
set Interfaces {
    s_axi_diff_io {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_diff_io"
        param_prefix "C_S_AXI_DIFF_IO"
        addr_bits "14"
        ...
        memories "img {base_address 4096 range 4096} window_V {base_address 8192 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 8.000000 machine 64 combinational 0 latency 26165 II x}
...
set enable_xo_gen 0
set kernel_files {C:/Users/jonas/source/repos/ERTS/Mini_Project/HLS/differentiate.cpp}
if {$enable_xo_gen} {
