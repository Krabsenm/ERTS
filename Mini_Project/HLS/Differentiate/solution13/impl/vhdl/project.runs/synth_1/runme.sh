...
HD_PWD='C:/Users/jonas/source/repos/ERTS/Mini_Project/HLS/Differentiate/solution13/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log differentiate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source differentiate.tcl
