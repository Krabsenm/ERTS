...
HD_PWD='C:/Users/jonas/source/repos/ERTS/Mini_Project/HLS/Differentiate/solution13/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log differentiate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source differentiate.tcl -notrace
